    ...
    : IDwellingService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var referenceCode =
            await ResolveReferenceCodeAsync(
                model.CampaignId,
                model.ReferenceCode,
                cancellationToken);
    ...
    private async Task<string> ResolveReferenceCodeAsync(
        Guid campaignId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return NormalizeReferenceCode(requestedReference);
        }
        ...
        for (var attempt = 0; attempt < 10; attempt++)
        {
            ...
            var candidate = $"HAB-{date}-{suffix}";

            var exists = await dwellingRepository
                .ExistsByReferenceIncludingDeletedAsync(
                    campaignId,
                    candidate,
                    excludedId: null,
        ...
        throw new ConflictException(
            "Impossible de générer une référence d’habitation unique.");
    }
