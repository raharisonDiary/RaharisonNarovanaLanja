    ...
    : IEntityTypeConfiguration<Person>
{
        ...
        EntityTypeBuilder<Person> builder)
    {
        ...
        builder.Property(person => person.BirthDatePrecision)
            .HasColumnName("birth_date_precision")
            .HasConversion<string>()
            .HasMaxLength(30)
            .IsRequired();

        builder.Property(person => person.BirthPlace)
        ...
        builder.Property(person => person.ChildrenCount)
        ...
        builder.Property(person => person.NationalIdIssueDate)
            .HasColumnName("national_id_issue_date")
            .HasColumnType("date");

        builder.Property(person => person.NationalIdIssuePlace)
            .HasColumnName("national_id_issue_place")
            .HasMaxLength(150);

        builder.Property(person => person.PhotoDataUrl)
            .HasColumnName("photo_data_url")
            .HasColumnType("text");
