...
public static class SessionSecurityExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services
            ...
            .Validate(
                options => options.IsValid(),
                "La configuration de récupération de mot de passe est invalide.")
            .ValidateOnStart();
        ...
        services
            ...
            .Bind(configuration.GetSection(
                PasswordRecoveryEmailOptions.SectionName))
            .Validate(
                options => options.IsValid(),
                "La configuration SMTP de récupération est invalide.")
            .ValidateOnStart();
