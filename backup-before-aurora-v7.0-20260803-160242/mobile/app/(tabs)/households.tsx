...
const styles = StyleSheet.create({
  ...
  list: { paddingHorizontal: spacing.lg, paddingBottom: 230, gap: 12 },
  card: {
    backgroundColor: colors.white,
    borderWidth: 1,
    borderColor: colors.border,
  ...
  cardHead: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, padding: spacing.lg },
  code: { fontSize: 11, fontWeight: '900', color: colors.primary },
  ...
  action: { minHeight: 46, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingHorizontal: 10 },
  actionText: { fontSize: 10, color: colors.textSoft, fontWeight: '700' },
  empty: { alignItems: 'center', gap: 10, paddingTop: 70, paddingHorizontal: spacing.xl },
  emptyText: { color: colors.text, fontWeight: '900' },
  emptyHint: { color: colors.muted, textAlign: 'center', lineHeight: 18, fontSize: 11 },
  fabGroup: { position: 'absolute', left: 16, right: 16, bottom: 94, gap: 8 },
  overlay: { flex: 1, backgroundColor: 'rgba(15,23,42,.58)', justifyContent: 'center', padding: spacing.lg },
  modalCard: { backgroundColor: colors.white, borderRadius: radius.xl, padding: spacing.xl, gap: 14 },
