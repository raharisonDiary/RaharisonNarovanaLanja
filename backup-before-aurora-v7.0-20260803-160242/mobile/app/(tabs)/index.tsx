    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <View style={styles.hero}>
        ...
        <View style={styles.heroTop}>
          <View>
            <Text style={styles.heroLabel}>M̩nages valid̩s</Text>
            <Text style={styles.heroValue}>{validationRate}%</Text>
          </View>
          <View style={styles.heroBadge}>
            <Text style={styles.heroBadgeText}>
              {dashboard?.totalHouseholds ?? 0} m̩nages
            </Text>
          </View>
        </View>
        ...
        <Text style={styles.heroHint}>
          Continuez la collecte ou synchronisez les donn̩es en attente.
        </Text>
      </View>
      ...
      <View style={styles.quickGrid}>
        <QuickAction
          ...
          title="Synchroniser"
          text={`${pending} ̩l̩ment(s) en attente`}
        ...
        <QuickAction
          ...
          title="Statistiques"
          text="Consulter les donn̩es valid̩es"
