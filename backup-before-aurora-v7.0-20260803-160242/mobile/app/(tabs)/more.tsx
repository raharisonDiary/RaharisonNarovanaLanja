...
const styles = StyleSheet.create({
  ...
  card: { width: '48%', minHeight: 128, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, padding: spacing.lg, justifyContent: 'space-between', ...shadow },
