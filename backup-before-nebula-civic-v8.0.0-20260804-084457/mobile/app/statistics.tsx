        ...
        <View style={styles.filterCard}>
          <View style={styles.filterTitleRow}>
            ...
            <View>
              ...
              <Text style={styles.filterHint}>Affinez la zone d’analyse</Text>
            </View>
          </View>
              ...
              <Svg style={StyleSheet.absoluteFill} width="100%" height="100%">
                <Defs>
                  <LinearGradient id="statsHero" x1="0" y1="0" x2="1" y2="1">
                    ...
                    <Stop offset="1" stopColor="#6C5200" />
                  </LinearGradient>
                </Defs>
...
function GenderDonut({
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.cardTitle}>Répartition par sexe</Text>
    ...
    <View style={styles.legendItem}>
      ...
      <View style={styles.legendCopy}>
        ...
        <Text style={styles.legendValue}>
          {format(value)} · {Math.round((value / total) * 100)}%
        </Text>
      </View>
    </View>
  )
