    ...
    : IApplicationUserService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var expectedAreaType = role switch
        {
            ...
            _ => (AdministrativeAreaType?)null
        };

        if (!expectedAreaType.HasValue)
        {
        ...
        {
            throw new BusinessValidationException(
                $"Le rôle {role} doit être associé à un territoire de type {expectedAreaType}.");
        }
        ...
        if (area.Type != expectedAreaType.Value)
        {
            throw new BusinessValidationException(
                $"Le rôle {role} exige un territoire de type {expectedAreaType}.");
        }
