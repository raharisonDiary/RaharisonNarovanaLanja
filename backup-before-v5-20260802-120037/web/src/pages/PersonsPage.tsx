import { Camera, Check, ChevronLeft, ChevronRight, Eye, Pencil, Plus, Search, Trash2 } from 'lucide-react'
        ...
        <div className="wizard-panel">
          {step === 0 && (
            <>
              ...
              />
              <label className="wizard-photo">
                {form.photoDataUrl
                  ? <img src={form.photoDataUrl} alt={t('citizenPhoto')} />
                  : <span className="wizard-photo__empty"><Camera size={42} />{t('takeCitizenPhoto')}</span>}
                <input
                  hidden
                  type="file"
                  accept="image/*"
                  ...
                  onChange={(event) => {
                    ...
                    void compressImage(file)
                      .then((value) => setValue('photoDataUrl', value))
