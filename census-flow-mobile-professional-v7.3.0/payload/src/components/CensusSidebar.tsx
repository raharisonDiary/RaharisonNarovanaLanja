...
function NavRow({
  ...
  return (
    ...
    >
      ...
      >
        <Icon
          color={active ? '#07111F' : palette.sidebarMuted}
          size={19}
      ...
      <Text
        ...
        style={[
          styles.navLabel,
          { color: active ? '#FFFFFF' : palette.sidebarText },
        ]}
      >
        {item.label}
      </Text>
      <ChevronRight
        color={active ? palette.sidebarAccent : '#62738B'}
        size={15}
      />
    </Pressable>
  )
      ...
      <View style={styles.themeRow}>
        {themes.map(({ value, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              <Icon
                color={selected ? '#07111F' : palette.sidebarMuted}
                size={14}
              />
              <Text
                style={[
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[styles.sectionLabel, { color: '#7F91A9' }]}>NAVIGATION</Text>
      ...
      <View style={[styles.main, { backgroundColor: palette.page }]}>
        {!desktop ? (
          ...
          >
            ...
            >
              {isDark ? (
                <Sun color="#9CC3FF" size={17} />
              ) : (
                <Moon color="#9CC3FF" size={17} />
              )}
            </Pressable>
          </View>
        ) : null}
...
const styles = StyleSheet.create({
  ...
  navRowActive: {
    backgroundColor: 'rgba(120,169,255,0.16)',
    borderWidth: 1,
    borderColor: 'rgba(120,169,255,0.18)',
  },
  navRowPressed: { backgroundColor: 'rgba(255,255,255,0.08)' },
  navIcon: {
    width: 34,
    height: 34,
    borderRadius: 11,
  ...
  languageButtonActive: { backgroundColor: 'rgba(120,169,255,0.16)' },
  ...
  menuButton: {
    ...
    backgroundColor: 'rgba(120,169,255,0.16)',
    borderWidth: 1,
    borderColor: 'rgba(120,169,255,0.24)',
  },
