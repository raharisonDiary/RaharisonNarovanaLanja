      ...
      >
        ...
        >
          ...
          <View style={styles.ctaArrow}>
            <ArrowRight color={colors.navy} size={20} />
          </View>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  ctaLabel: { color: '#6C5200', fontSize: 8, fontWeight: '900', letterSpacing: 1.1 },
  ctaText: { color: colors.navy, fontSize: 16, fontWeight: '900', marginTop: 2 },
  ctaArrow: {
    width: 40,
    height: 40,
    borderRadius: 14,
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: 'rgba(7,17,31,.10)',
  },
