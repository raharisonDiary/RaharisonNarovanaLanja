...
export function GradientSurface({
  ...
  const gradient =
    variant === 'success'
      ...
      : variant === 'primary'
        ? [palette.heroStart, palette.heroMiddle, '#6C5200']
        : variant === 'hero'
  ...
  return (
    <Animated.View
      style={[
        styles.gradientSurface,
        {
          ...
          borderColor: isDark ? 'rgba(255,211,78,0.18)' : 'rgba(244,180,0,0.20)',
          opacity,
    ...
    >
      <Svg pointerEvents="none" style={StyleSheet.absoluteFill} width="100%" height="100%">
        ...
        {decorative ? (
          <>
            <Circle cx="92%" cy="2%" r="84" fill="rgba(255,211,78,0.12)" />
            <Circle cx="100%" cy="100%" r="72" fill="rgba(45,212,191,0.10)" />
